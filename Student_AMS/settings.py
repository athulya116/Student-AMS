"""
Django settings for Student_AMS project.
...
WSGI_APPLICATION = 'Student_AMS.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / "static",   # this points to main_folder/static
]
